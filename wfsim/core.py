...
class S2(Pulse):
    ...
    def __call__(self, instruction):
        ...
        #lets print the s2 secondary sc gain to test the changed instructions....
        #print("###########################")
        #print("s2_secondary_sc_gain:", self.config['s2_secondary_sc_gain'])
        #print("###########################")
    ...
    def photon_channels(self, points):
        ...
        for u, n in zip(*np.unique(self._instruction, return_counts=True)):
            ...
            #only distribute on working pmts? -> match aft
            #p_per_channel[np.in1d(channels, self.turned_off_pmts)] = 0
